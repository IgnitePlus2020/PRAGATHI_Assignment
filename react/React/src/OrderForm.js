               ...
               <div className="order_form">
                   {this.EmptyRootBelow()}
                    <form onSubmit={this.handleSubmit}>
                       ...
                       <label>Fruits : </label>
                       <select className="widthDropdown" value={this.state.order} onChange={this.handleChangeOrder}>
                            <option value="Orange Rs.50">Orange Rs.50</option>
                            <option value="Grapes Rs.100">Grapes Rs.100</option>
                            <option value="Mango Rs.60">Mango Rs.60</option>
                            <option value="Banana Rs.30">Banana Rs.30</option>
                            <option value="Apple Rs.150">Apple Rs.150</option>
                       </select>
                       <label>Quantity: </label>
                       <input type="text" name="qty" required onChange={this.handleChangeQty}></input>
                       <button type="button"  onClick={() => this.handleAdd()} >Add</button><br/><br/>
